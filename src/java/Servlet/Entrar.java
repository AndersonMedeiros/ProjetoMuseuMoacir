...
public class Entrar extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (usuDao.validarLoginSenha(request.getParameter("txtLogin"), request.getParameter("txtSenha"))) {
            usu = usuDao.getUsuario(request.getParameter("txtLogin"));
            ...
            sessao.setAttribute("login_usuario", "erro");
            String url = "/Entrar_Cadastro.jsp";
            RequestDispatcher despachante = getServletContext().getRequestDispatcher(url);
            despachante.forward(request, response);
        }
    }
